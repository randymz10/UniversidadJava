 ...
 * 
 */
@WebService(name = "ServicioSumaWS", targetNamespace = "http://beans/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface ServicioSumaWS {
    ...
    @Action(input = "http://beans/ServicioSumaWS/sumarRequest", output = "http://beans/ServicioSumaWS/sumarResponse")
    public int sumar(
